#------------------------------------------------------------
# Demo of the free motion ellipsoide of a symmetric top 
...
class RetinaInputs():
    ...
    def __init__(self, I1 = 1.0, I3 = 2.0,
    ...
    def _init_everything(self):
        ...
        self.window.lights = [0.2*norm((1,-0.5,-0.2)),0.6*norm((1,0.5,0.2))]
        self.window.select()
        try:
